  ...
  return (
    <View style={styles.container}>
      <View style={styles.group2}>
        ...
        <Text style={styles.udariSithupraba}>{user.fullName}</Text>
        ...
        <View style={styles.icon7Row}>
          ...
          <View style={styles.email1Column}>
            ...
            <Text style={styles.udariGmailCom}>{user.email}</Text>
          </View>
        </View>
        <View style={styles.icon8Row}>
          ...
          <View style={styles.passportNoColumn}>
            ...
            <Text style={styles.nkravindu2}>{user.passportNo}</Text>
          </View>
        </View>
        <View style={styles.icon9Row}>
          ...
          <View style={styles.countryColumn}>
            ...
            <Text style={styles.australia}>{user.country}</Text>
          </View>
        </View>
